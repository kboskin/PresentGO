...
class GiftActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // open database
        try {
            Log.d("DbHelper", myDbHelper.readableDatabase.toString())
            myDbHelper.openDataBase()

            // raw for results
            val cursor: Cursor = myDbHelper.readableDatabase.rawQuery(query, null);
        ...
        // set title
        gift_title.text = randomItem.name.toUpperCase()
